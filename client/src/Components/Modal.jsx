			...
			<motion.div
				...
				<div className="w-full h-full relative">
					<motion.div
						...
						className="
						text-secondary h-fit flex flex-col items-center justify-center px-4 py-10 absolute rounded-xl border w-fit top-1/2 -translate-y-1/2 left-1/2 -translate-x-1/2
						lg:px-12">
